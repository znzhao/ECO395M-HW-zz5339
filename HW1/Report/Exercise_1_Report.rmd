...
p9 = ggplot(GB_summ4,aes(x = age, y = leasing_rate))+
  ...
  annotate("text", x = -0.5, y = 0.43, label = "47%", col=brewer.pal(6, "Reds")[5])+
  annotate("text", x = -0.7, y = 0.65, label = "56%", col=brewer.pal(6, "Greens")[5])+
  annotate("text", x = 1.5, y = 0.6, label = "65%", col=brewer.pal(6, "Reds")[5])+
  annotate("text", x = 0.5, y = 0.81, label = "79%", col=brewer.pal(6, "Greens")[5] )+
  annotate("text", x = 3.5, y = 0.69, label = "67%", col=brewer.pal(6, "Reds")[5])+
  annotate("text", x = 2, y = 0.95, label = "89%", col=brewer.pal(6, "Greens")[5])+
