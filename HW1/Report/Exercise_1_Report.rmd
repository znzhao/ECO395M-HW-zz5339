...
p6 = ggplot(GB_summ_a, aes(x=amenities, y=Rent_mean,fill=Green)) + 
  ...
  geom_text(aes(x=amenities,y=Rent_mean,label=round(Rent_mean, 2)),vjust=-0.1,col="black",position = position_dodge(0.9))+
...
p9 = ggplot(GB_summ4,aes(x = age, y = leasing_rate))+
  ...
  annotate("text", x = 0, y = 0.43, label = "47%", col=brewer.pal(6, "Reds")[5])+
  annotate("text", x = -0.6, y = 0.60, label = "56%", col=brewer.pal(6, "Greens")[5])+
  annotate("text", x = 1.7, y = 0.62, label = "65%", col=brewer.pal(6, "Reds")[5])+
  annotate("text", x = 0.5, y = 0.82, label = "79%", col=brewer.pal(6, "Greens")[5])+
  annotate("text", x = 3, y = 0.67, label = "67%", col=brewer.pal(6, "Reds")[5])+
  annotate("text", x = 1.5, y = 0.93, label = "89%", col=brewer.pal(6, "Greens")[5])+
