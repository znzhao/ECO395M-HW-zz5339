...
# 
# brca_13 <- subset(brca,(brca$radiologist =="radiologist13"))
# brca_34 <- subset(brca,(brca$radiologist =="radiologist34"))
# brca_66 <- subset(brca,(brca$radiologist =="radiologist66"))
# brca_89 <- subset(brca,(brca$radiologist =="radiologist89"))
# brca_95 <- subset(brca,(brca$radiologist =="radiologist95"))
...
Err = do(100)*{
  ...
  #summary(glm_modelA)
  glm_modelB = glm(cancer~ ., data = DF_train)
  #summary(glm_modelB)
